...
import 'package:firebasestore/screen/opening_screen.dart';
import 'package:firebasestore/screen/splashscreeen.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Certificates Holder'),
        actions: [
          IconButton(icon:Icon(Icons.add_a_photo_rounded ),
            onPressed:(){
              Navigator.of(context).push(MaterialPageRoute(builder: (context) =>ADD()));
            },
          ),
          IconButton(icon:Icon(Icons.add_alert_sharp),
            onPressed:(){
